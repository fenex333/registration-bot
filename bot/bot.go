...
func (b *Bot) SendApprovedMessage(chatID int64, name string) {
	text := fmt.Sprintf(
		"🎉 <b>Поздравляем, %s!</b>\n\n"+
			...
			"Вот <a href=\"https://checkout.revolut.com/pay/3e33877d-b649-4f20-8ab2-714f29a8bee3\">ссылка</a> на оплату\n\n"+
